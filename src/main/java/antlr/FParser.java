...
public class FParser extends Parser {
	...
	public static final int
		...
		INTEGER=53, REAL=54, IdentifierName=55, Whitespace=56, Newline=57, MultiLineMacro=58;
	public static final int
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, "INTEGER", "REAL", "IdentifierName", "Whitespace", 
		"Newline", "MultiLineMacro"
	};
	...
	public final TailContext tail() throws RecognitionException {
		...
		try {
			...
			case T__17:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__13) | (1L << T__14) | (1L << T__17) | (1L << T__19) | (1L << T__22) | (1L << T__26) | (1L << T__46) | (1L << T__47) | (1L << T__48) | (1L << T__49) | (1L << INTEGER) | (1L << REAL) | (1L << IdentifierName))) != 0)) {
					{
					setState(162);
					expressions();
					}
	...
	public static class Complex_literalContext extends ParserRuleContext {
		public List<TerminalNode> REAL() { return getTokens(FParser.REAL); }
		public TerminalNode REAL(int i) {
			return getToken(FParser.REAL, i);
		}
	...
	public static final String _serializedATN =
		...
		")\r)\16)\u0181\3)\3)\3)\6)\u0187\n)\r)\16)\u0188\3)\5)\u018c\n)\3*\3*"+
		"\3*\3*\3+\3+\3+\3+\3,\3,\3,\4\u0181\u0188\2-\2\4\6\b\n\f\16\20\22\24\26"+
		"\30\32\34\36 \"$&(*,.\60\62\64\668:<>@BDFHJLNPRTV\2\7\3\2\7\t\3\2\n\17"+
		"\3\2\20\21\3\2\22\23\3\2\61\62\2\u01ab\2Y\3\2\2\2\4]\3\2\2\2\6e\3\2\2"+
		"\2\bm\3\2\2\2\nu\3\2\2\2\fz\3\2\2\2\16\177\3\2\2\2\20\u0087\3\2\2\2\22"+
		"\u0090\3\2\2\2\24\u0094\3\2\2\2\26\u00a1\3\2\2\2\30\u00b2\3\2\2\2\32\u00bb"+
		"\3\2\2\2\34\u00bd\3\2\2\2\36\u00c9\3\2\2\2 \u00cb\3\2\2\2\"\u00cf\3\2"+
		"\2\2$\u00dd\3\2\2\2&\u00df\3\2\2\2(\u00e1\3\2\2\2*\u00e3\3\2\2\2,\u00f1"+
		...
		"\2\2R\u018d\3\2\2\2T\u0191\3\2\2\2V\u0195\3\2\2\2XZ\5\4\3\2YX\3\2\2\2"+
		...
		"\u017a\7\67\2\2\u017aM\3\2\2\2\u017b\u017c\78\2\2\u017cO\3\2\2\2\u017d"+
		...
		"\2\2\2\u018cQ\3\2\2\2\u018d\u018e\78\2\2\u018e\u018f\7\65\2\2\u018f\u0190"+
		"\78\2\2\u0190S\3\2\2\2\u0191\u0192\7\67\2\2\u0192\u0193\7\66\2\2\u0193"+
		"\u0194\7\67\2\2\u0194U\3\2\2\2\u0195\u0196\79\2\2\u0196W\3\2\2\2+Ybhr"+
		"x}\u0084\u008c\u0090\u0096\u00a1\u00a5\u00aa\u00b0\u00b2\u00bb\u00c0\u00c5"+
		"\u00d4\u00dd\u00e9\u00f1\u00fb\u010a\u010d\u011e\u0121\u0126\u0133\u013a"+
		"\u0142\u0146\u014a\u014e\u0154\u0160\u0166\u016b\u0181\u0188\u018b";
